    ...
    if request.method == "POST":
        try:
            ...
            if not full_text:
                ...
                # Generate summaries for each extracted image using absolute file paths
                image_full_paths = [os.path.join(app.static_folder, p) for p in session["extracted_images"]]
                image_summaries = gemini_image_summarize(image_full_paths)
                ...
                summary = summarize_text(
                    ...
                    vision_failure_signal=vision_failure_signal
                )
